<template>
    <Transition name="popup-fade">
        <div v-if="selectedIsland" :style="infoBoxStyle"
            ...
            <h3 class="text-lg font-bold text-center shrink-0">{{ selectedIslandName }}</h3>
                    ...
                    <div v-if="!loading" class="w-full mt-3 space-y-3">
                        ...
                        <div v-else class="w-full space-y-3">
                            ...
                            <button
                                ...
                                @pointerdown.stop="$emit('travelToIsland', selectedIsland)"
...
const isCurrentIsland = computed(() => props.selectedIsland && props.player && props.selectedIsland === props.player.atIsland);
